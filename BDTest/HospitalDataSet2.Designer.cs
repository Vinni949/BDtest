...
namespace BDTest {
    ...
    public partial class HospitalDataSet2 : global::System.Data.DataSet {
        ...
        public partial class PatientDataTable : global::System.Data.TypedTableBase<PatientRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PatientRow AddPatientRow(string FirstName, string LastName, string Adress, byte Age, string complaints) {
        ...
        public partial class PatientRow : global::System.Data.DataRow {
            ...
            public string LastName {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'LastName\' в таблице \'Patient\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public byte Age {
                get {
                    try {
                        return ((byte)(this[this.tablePatient.AgeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public string complaints {
                get {
                    try {
                        return ((string)(this[this.tablePatient.complaintsColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'complaints\' в таблице \'Patient\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tablePatient.complaintsColumn] = value;
                }
            }
            ...
            public bool IscomplaintsNull() {
                return this.IsNull(this.tablePatient.complaintsColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetcomplaintsNull() {
                this[this.tablePatient.complaintsColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace BDTest.HospitalDataSet2TableAdapters {
    ...
    public partial class PatientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_complaints", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "complaints", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Patient] ([FirstName], [LastName], [Adress], [Age], [complaint" +
                "s]) VALUES (@FirstName, @LastName, @Adress, @Age, @complaints);\r\nSELECT ID, Firs" +
                "tName, LastName, Adress, Age, complaints FROM Patient WHERE (ID = SCOPE_IDENTITY" +
                "())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Patient] SET [FirstName] = @FirstName, [LastName] = @LastName, [Adress] = @Adress, [Age] = @Age, [complaints] = @complaints WHERE (([ID] = @Original_ID) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Adress = 1 AND [Adress] IS NULL) OR ([Adress] = @Original_Adress)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_complaints = 1 AND [complaints] IS NULL) OR ([complaints] = @Original_complaints)));
SELECT ID, FirstName, LastName, Adress, Age, complaints FROM Patient WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_complaints", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "complaints", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, FirstName, LastName, Adress, Age, complaints FROM dbo.Patient";
        ...
        public virtual int Delete(int Original_ID, string Original_FirstName, string Original_LastName, string Original_Adress, global::System.Nullable<byte> Original_Age, string Original_complaints) {
        ...
        public virtual int Insert(string FirstName, string LastName, string Adress, global::System.Nullable<byte> Age, string complaints) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string Adress, global::System.Nullable<byte> Age, string complaints, int Original_ID, string Original_FirstName, string Original_LastName, string Original_Adress, global::System.Nullable<byte> Original_Age, string Original_complaints, int ID) {
            if ((FirstName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Adress, global::System.Nullable<byte> Age, string complaints, int Original_ID, string Original_FirstName, string Original_LastName, string Original_Adress, global::System.Nullable<byte> Original_Age, string Original_complaints) {
            return this.Update(FirstName, LastName, Adress, Age, complaints, Original_ID, Original_FirstName, Original_LastName, Original_Adress, Original_Age, Original_complaints, Original_ID);
        }
    }
